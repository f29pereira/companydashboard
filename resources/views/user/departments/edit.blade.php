...
@section('title', __('page.titles.departments-edit'))
            ...
            <div class="card card-info">
                ...
                <div class="card-header d-flex justify-content-between">
                    ...
                    <h3 class="card-title">
                        ...
                        {{ __('page.departments.edit-title') }}
                    </h3>
                </div>
                {{-- Card Body --}}
                <div class="card-body">
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            data-toggle="tooltip" data-placement="right" title="{{ __('page.departments.tip-edit') }}"></i>
                        </div>
                    </div>
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        value="{{ $department->department_name }}" placeholder="{{ __('page.departments.text-update-name') }}">
