        ...
        <div class="col m-3">
            ...
            <div class="card card-info">
                ...
                <div class="card-header d-flex justify-content-between">
                    ...
                    {{-- Card Title --}}
                    <h3 class="card-title"><i class="far fa-handshake fa-lg"></i></i>&nbsp;&nbsp;&nbsp;{{ __('card.company_types.title-create') }}</h3>
                </div>
                {{-- Card Body --}}
                <div class="card-body">
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            data-toggle="tooltip" data-placement="right" title="{{ __('tooltip.company_types.create') }}"></i>
                        </div>
                    </div>
                            ...
                            <div class="col-md-4 mb-3 mr-5">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        value="{{ old('type_name') }}" placeholder="{{ __('form.company_types.type_name_placeholder') }}" autofocus>
                            ...
                            <div class="col-md-4 mb-3 mr-5">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        value="{{ old('type_description') }}" placeholder="{{ __('form.company_types.type_description_placeholder') }}">
                                        <div class="input-group-append">
                                            <div class="input-group-text">
                                                <span><i class="fas fa-align-justify fa-lg text-info"></i></span>
                                            </div>
