        ...
        <div class="col m-3">
            ...
            <div class="card card-info">
                ...
                <div class="card-header d-flex justify-content-between">
                    ...
                    {{-- Card Title --}}
                    <h3 class="card-title"><i class="far fa-handshake fa-lg"></i></i>&nbsp;&nbsp;&nbsp;Registar Relação de Negócio</h3>
                </div>
                {{-- Card Body --}}
                <div class="card-body">
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            data-toggle="tooltip" data-placement="right" title="Formulário para registo de relação de negócio"></i>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3 mr-5">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="type_name" id="companyTypeName" placeholder="Nome da Relação de Negócio">
                            ...
                            <div class="col-md-4 mb-3 mr-5">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="type_description" id="companyTypeDescription" placeholder="Descrição da Relação de Negócio">
                                        <div class="input-group-append">
                                            <span class="input-group-text"><i class="fas fa-align-justify fa-lg text-info"></i></span>
                                        </div>
                                    </div>
